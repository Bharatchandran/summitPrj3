...
urlpatterns = [ 
    ...
    path('interests/', views.Interest.as_view(), name='interest_index'),
    path('interests/<int:pk>/', views.Interest.as_view(), name='interest_detail'),
    ...
    path('groups/', views.Groups.as_view(), name='group_index'),
    path('groups/<int:pk>/', views.Groups.as_view(), name='group_detail'),
